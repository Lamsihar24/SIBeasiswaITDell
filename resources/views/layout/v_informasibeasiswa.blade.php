        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
            ...
            ?> 
                    ...
                    @endif</td>
                    <td>
                      <a href="/home/detailbeasiswa/{{ $data->id_beasiswa }}" class="btn btn-sm btn-primary">Detail</a>
                      <a href="/home/ubahinformasibeasiswa/{{ $data->id_beasiswa }}" class="btn btn-sm btn-primary">Ubah</a>
                      <a href="/home/deletebeasiswa/{{ $data->id_beasiswa }}" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
