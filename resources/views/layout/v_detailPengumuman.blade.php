  ...
  <div class="main-content" id="panel">
    ...
    <span>
        <center>
          ...
          <h3 style="color: white;">{{ $pengumuman->judul_peng }}</h3>
        <h3 style="color: white;">Time {{ $pengumuman->time_peng }}</h3>
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
          <div class="card">
            ...
            <div>
              <a href="{{ $pengumuman->info_peng }}" target="blank">{{ $pengumuman->info_peng }}</a>
            </div>
