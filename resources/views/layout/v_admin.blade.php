          ...
          <form class="navbar-search navbar-search-light form-inline float-right" id="navbar-search-main">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <input class="form-control" placeholder="Search" name="cari" value="{{ old('cari') }}" type="search">
                </form>
              </div>
            </div>
    ...
    <div class="container-fluid mt--6">
      ...
      <div class="row">
        ...
        <tr> 
           ...
           <td>
              <a href="/home/detail/{{ $data->id_peng }}" class="btn btn-sm btn-primary" >Detail</a>
              <a href="/home/edit/{{ $data->id_peng }}" class="btn btn-sm btn-primary">Ubah</a>
              <a href="/home/delete/{{ $data->id_peng }}" class="btn btn-sm btn-danger">Hapus</a>
           </td>
        </tr>
        @endforeach
                </tbody>
