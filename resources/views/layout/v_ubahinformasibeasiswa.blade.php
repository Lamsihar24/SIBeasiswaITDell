          ...
          <div class="card-header border-0">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                <tbody>
                  <form action="/home/updatebea/{{ $beasiswa->id_beasiswa }}" method="POST" enctype="multipart/form-data">
                  @csrf
                
                    <div class=" form-group">
                        <label>Beasiswa</label>
                        <input type="text" name="nama_beasiswa" class="form-control " value="{{ $beasiswa->nama_beasiswa }}" >
                    </div>
                    <div class=" form-group">
                        <label>Jumlah Diterima</label>
                        <input type="text" name="jlh_daftar" class="form-control " value="{{ $beasiswa->jlh_daftar }}" >
                    </div>
                    <div class=" form-group">
                        <label>Deadline</label>
                        <input type="date" name="deadline" class="form-control " value="{{ $beasiswa->deadline }}" >
                    </div>
                    <div class=" form-group">
                        <label>Link info / berkas</label>
                        <input type="text" name="info_beasiswa" class="form-control " value="{{ $beasiswa->info_beasiswa }}" >
                    </div>
                    <div class=" form-group">
                        <label>Status</label>
                        <input type="text" name="status" class="form-control " value="{{ $beasiswa->status }}" >
                    </div>

                    <div class=" form-group">
                        <label>Persyaratan</label>
                        <input type="text " name="persyaratan" class="form-control " value="{{ $beasiswa->persyaratan }}">
                    </div>
                    <div class=" form-group">
                        <label>Deskripsi</label>
                        <input type="text" name="deskripsi_beasiswa" class="form-control " value="{{ $beasiswa->deskripsi_beasiswa }}" >
                    </div>
