...
<body>
  ...
  <div class="main-content" id="panel">
            ...
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <form action="/home" method="GET">
                  <input class="form-control" name="cari" placeholder="Search" type="search" value="{{ old('cari') }}">
          ...
          <div class="card-header border-0">
            ...
            <?php $no=1 ?>
                        ...
                        {{-- <tr> 
                          ...
                          <td>
                            <a href="/home/detailbeasiswa/{{ $data->id_beasiswa }}" >Detail</a> --}}
                            {{-- <a href="/home/edit/{{ $data->id_peng }}" >Edit</a>
                            <a href="/home/delete/{{ $data->id_peng }}">Delete</a> --}}
            ...
            ?> 
                    ...
                    @endif</td>
                    <td><a href="/home/detailbeasiswa/{{ $data->id_beasiswa }}" >Detail</a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
    ...
    <!--Table 2-->
        ...
        <tr> 
            <td>{{ $data->judul_peng }}</td>
            <td>{{ $data->time_peng }}</td>
           <td>
             <a href="/home/detail/{{ $data->id_peng }}" >Detail</a>
           </td>
        </tr>
        @endforeach
    </tbody>
