        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Permohonan Pencairan Dana dari Keuangan</h3>
                </div>
              </div>
              <div class="col text">
        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Daftar Pencairan Dana Mahasiswa</h3>
                </div>
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tr>
                    ...
                    30.000.000                    </td>
                    <td>
                    <a href="/home/detailkeuangan" class="btn btn-sm btn-primary">Detail</a>
                    </td>
                  </tr>
                  <tr>
                    <th scope="row">
...
<?php /**PATH E:\xampp\htdocs\MudahmudahanLancar\belajar-laravel\resources\views/layout/v_keuangankemahasiswaan.blade.php ENDPATH**/ ?>