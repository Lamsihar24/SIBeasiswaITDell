              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="date" name="id_beasiswadaftar" class="form-control " value="11/21/2021" >
                    </div>
                    <div class=" form-group">
                        <label>File</label>
                        <input type="file" name="id_beasiswadaftar" class="form-control " value="nama beasiswa" >
                    </div>
...
<?php /**PATH E:\xampp\htdocs\MudahmudahanLancar\belajar-laravel\resources\views/layout/v_editpengumuman.blade.php ENDPATH**/ ?>