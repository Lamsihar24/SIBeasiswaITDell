          ...
          <form class="navbar-search navbar-search-light form-inline float-right" id="navbar-search-main">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <input class="form-control" placeholder="Search" name="cari" value="<?php echo e(old('cari')); ?>" type="search">
                </form>
              </div>
            </div>
        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Daftar Beasiswa</h3>
                </div>
            ...
            ?> 
                    ...
                    <?php endif; ?></td>
                    <td>
                      <a href="/home/detailbeasiswa/<?php echo e($data->id_beasiswa); ?>" class="btn btn-sm btn-primary">Detail</a>
                      <a href="/home/ubahinformasibeasiswa/<?php echo e($data->id_beasiswa); ?>" class="btn btn-sm btn-primary">Ubah</a>
                      <a href="/home/deletebeasiswa/<?php echo e($data->id_beasiswa); ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
...
<?php /**PATH C:\xampp\htdocs\lataa\a\a\belajar-laravel\resources\views/layout/v_informasibeasiswa.blade.php ENDPATH**/ ?>