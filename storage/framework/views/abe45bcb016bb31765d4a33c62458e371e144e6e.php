...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group has-feedback">
        <input type="text" name="pstudy" class="form-control" placeholder="Program Study">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
        <?php $__errorArgs = ['pstudy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\lataa\as\ab\belajar-laravel\belajar-laravel\resources\views/v_register.blade.php ENDPATH**/ ?>