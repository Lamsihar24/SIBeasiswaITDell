...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label>Info Lin Berkas</label>
                    <input type="text" name="info_peng" class="form-control <?php $__errorArgs = ['info_peng'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($pengumuman->info_peng); ?>">
                    <div class="tex-danger">
                        <?php $__errorArgs = ['info_peng'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\lataa\a\a\belajar-laravel\resources\views/layout/v_editpengumuman.blade.php ENDPATH**/ ?>