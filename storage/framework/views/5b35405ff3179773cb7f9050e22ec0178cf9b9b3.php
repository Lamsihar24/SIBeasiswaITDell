        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Data Penerima Mahasiswa</h3>
                </div>
              ...
              <div class=" text">
                  Angkatan 
                  <input type="text" name="" class="form-control text-right" style="width: min-content;">

                </div>
                <div class="text">
                  Program Studi 
                  <input type="text" name="" class="form-control " style="width: min-content;">

                </div>
                <div class="col text">
                <button type="button" class="btn btn-primary text">Cari</button> 
            ...
            <div class="table-responsive">
              ...
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0 text">Daftar Rekomendasi Penerima Beasiswa Dari Wali Kelas</h3>
                </div>
...
<?php /**PATH E:\xampp\htdocs\MudahmudahanLancar\belajar-laravel\resources\views/layout/v_rekomendasi.blade.php ENDPATH**/ ?>