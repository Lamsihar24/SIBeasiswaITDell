        ...
        <div class="col-xl-12">
          ...
          <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Edit Informasi beasiswa</h3>
                </div>
                <!-- <div class="col text-right">
                  <a href="#!" class="btn btn-sm btn-primary">Tampilkan Semua</a>
                  <a href="/home/add" class="btn btn-sm btn-success">Tambah</a>
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                <tbody>
                  <form action="/home/updatebea/<?php echo e($beasiswa->id_beasiswa); ?>" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                
                    <div class=" form-group">
                        <label>Beasiswa</label>
                        <input type="text" name="nama_beasiswa" class="form-control " value="<?php echo e($beasiswa->nama_beasiswa); ?>" >
                    </div>
                    <div class=" form-group">
                        <label>Jumlah Diterima</label>
                        <input type="text" name="jlh_daftar" class="form-control " value="<?php echo e($beasiswa->jlh_daftar); ?>" >
                    </div>
                    <div class=" form-group">
                        <label>Deadline</label>
                        <input type="date" name="deadline" class="form-control " value="<?php echo e($beasiswa->deadline); ?>" >
                    </div>
                    <div class=" form-group">
                        <label>Link info / berkas</label>
                        <input type="text" name="info_beasiswa" class="form-control " value="<?php echo e($beasiswa->info_beasiswa); ?>" >
                    </div>
                    <div class=" form-group">
                        <label>Status</label>
                        <input type="text" name="status" class="form-control " value="<?php echo e($beasiswa->status); ?>" >
                    </div>

                    <div class=" form-group">
                        <label>Persyaratan</label>
                        <input type="text " name="persyaratan" class="form-control " value="<?php echo e($beasiswa->persyaratan); ?>">
                    </div>
                    <div class=" form-group">
                        <label>Deskripsi</label>
                        <input type="text" name="deskripsi_beasiswa" class="form-control " value="<?php echo e($beasiswa->deskripsi_beasiswa); ?>" >
                    </div>
...
<?php /**PATH C:\xampp\htdocs\lataa\a\a\belajar-laravel\resources\views/layout/v_ubahinformasibeasiswa.blade.php ENDPATH**/ ?>