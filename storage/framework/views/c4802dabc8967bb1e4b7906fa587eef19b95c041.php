            ...
            <div class="table-responsive">
              ...
              <div class="col text">
                ...
                <br>
                    ...
                    <div class="form-group-right">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="isi_peng"></textarea>
                    </div>
                ...
                <br>
                    ...
                    <div class="form-group-right">
                      <input type="text" name="info_peng" class="form-control">
                    </div>
                ...
                <br>
                    ...
                    <div class="form-group-right">
                    <input type="date" name="time_peng" class="form-control">
                    </div>
...
<?php /**PATH C:\xampp\htdocs\lataa\a\a\belajar-laravel\resources\views/layout/v_addpengumuman.blade.php ENDPATH**/ ?>