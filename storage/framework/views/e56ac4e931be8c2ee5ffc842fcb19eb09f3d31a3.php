              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="text" name="id_beasiswadaftar" class="form-control " value="nama beasiswa" >
                    </div>
                    <div class=" form-group">
                        <label>Jumlah Pendaftar</label>
                        <input type="text" name="id_beasiswadaftar" class="form-control " value="11/21/2021" >
                    </div>
                    <div class=" form-group">
                        <label>Deadline</label>
                        <input type="date" name="id_beasiswadaftar" class="form-control " value="nama beasiswa" >
                    </div>
                    <div class=" form-group">
...
<?php /**PATH E:\xampp\htdocs\MudahmudahanLancar\belajar-laravel\resources\views/layout/v_ubahinformasibeasiswa.blade.php ENDPATH**/ ?>