              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="text" name="id_beasiswadaftar" class="form-control " value="Nama Mahasiswa" >
                    </div>
                    <div class=" form-group">
                    ...
                    <div class=" form-group">
                        <label>Status</label>
                        <input type="text" name="id_beasiswadaftar" class="form-control " value="Status" >
                    </div>
                    <div class=" button">
...
<?php /**PATH E:\xampp\htdocs\MudahmudahanLancar\belajar-laravel\resources\views/layout/v_ubahdatamahasiswapendaftar.blade.php ENDPATH**/ ?>