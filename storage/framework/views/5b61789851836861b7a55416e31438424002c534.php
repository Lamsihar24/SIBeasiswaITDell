      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/home/datamahasiswa">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Nama Beasiswa</td>
                    <td>Beasiswa Potensi Cumlaude</td>
                  </tr>
                  <tr>
                    <td>IPK</td>
                    <td>3.93</td>
                  ...
                  <tr>
                    <td>Siapakah orang yang paling menginspirasi kamu?</td>
                    <td></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>Menurut mu, mengapa pendidikan tinggi itu penting?</td>
                    <td></td>
                  </tr>
                  <tr>
                    <td><textarea class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea></td>
                  ...
                  <tr>
                    <td>Ceritakan pengalaman kamu menjadi seorang pelajar dan dampaknya untuk lingkungan sekitar mu?</td>
                    <td></td>
                  </tr>
                  <tr>
                    <td><textarea class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea></td>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="">Formulir aplikasi.docs</a></td>
                  </tr>
                  <tr>
                    <td>Surat Rekomendasi dari Bapak/Ibu Dosen Wali</td>
                    <td><a href="">Bapak/Ibu Dosen Wali.docs</a></td>
                  </tr>
                  <tr>
                    <td>Surat Rekomendasi dari Bapak/Ibu Pembina Asrama</td>
                    <td><a href="">Bapak/Ibu PembinaAsrama.docs</a></td>
                  </tr>
                  <tr>
                    <td>Surat Pernyataan Tidak Menerima Beasiswa Lain</td>
                    <td><a href="">FSPTBeasiswaLain.docs</a></td>
                  </tr>
                  <tr>
                    <td>Softcopy foto berwarna ukuran 3 x 4 (formal)</td>
                    <td><a href="">Softcopy foto.png</a></td>
                  </tr>
                  <tr>
                    <td>Softcopy raport SMA kelas 3 yang sudah dilegalisir</td>
                    <td><a href="">Softcopy raport SMA.pdf</a></td>
                  </tr>
                  <tr>
                    <td>Slip gaji terakhir orang tua</td>
                    <td><a href="">Slip gaji.pdf</a></td>
                  </tr>
                  <tr>
                    <td>Softcopy Ijazah SMA asli</td>
                    <td><a href="">Softcopy Ijazah SMA asli.pdf</a></td>
                  </tr>
                  <tr>
                    <td>Softcopy KTP, Kartu Keluarga dan Akta Lahir</td>
                    <td><a href="">Sofcopy KTP, KK dan Akta Lahir.pdf</a></td>
                  </tr>
                  <tr>
                    <td>
                    
                    <button type="button" class="btn btn-success float-right">Diterima</button>
                    </td>
                    <td>
...
<?php /**PATH E:\xampp\htdocs\MudahmudahanLancar\belajar-laravel\resources\views/layout/v_detailpendaftar.blade.php ENDPATH**/ ?>